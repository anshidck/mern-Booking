...
const Hotel = () => {
  ...
  function dayDifference(date1, date2) {
    if (!(date1 instanceof Date && date2 instanceof Date)) {
      return 0; // Invalid dates, return 0 or handle the error appropriately
    }
  ...
  let days = 0;
  if (searchData && searchData.date && searchData.date[0]) {
    days = dayDifference(
  ...
  return (
    <div>
      ...
      <div className="hotelContainer">
        {open && (
         ...
         <div className="hotelWrapper">
            <button className="bookNow" onClick={() => handleClick(hotel._id)}>Reserve or Book Now!</button>
            ...
            <div className="hotelDetails">
              ...
              <div className="hotelDetailsPrice">
                ...
                <h2>
                  <b>${days * hotel.cheapestPrice * searchData.options?.room}</b> ({days}{" "}
                  nights)
                </h2>
                <button onClick={() => handleClick(hotel._id)}>Reserve or Book Now!</button>
              </div>
            </div>
          </div>
          <MailList />
      ...
      {openModal && <Reserve setOpen={setOpenModal} hotelId={hotel._id} dates={searchData.date} days={days}/>}
